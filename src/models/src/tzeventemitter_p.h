...
public:
    ...
    std::pair<std::uint64_t, std::string> addListener(const std::string& eventName, ListenerCallback callback);
    std::pair<std::uint64_t, std::string> addOnceListener(const std::string& eventName, ListenerCallback callback);
