...
template<typename Enum> class TzFlags;

class TzFlag
{
    std::int32_t i;
public:
    constexpr inline TzFlag(std::int32_t value) noexcept : i(value) {}
    constexpr inline operator std::int32_t() const noexcept { return i; }

    constexpr inline TzFlag(std::uint32_t value) noexcept : i(std::int32_t(value)) {}
    constexpr inline TzFlag(short value) noexcept : i(std::int32_t(value)) {}
    constexpr inline TzFlag(unsigned short value) noexcept : i(std::int32_t(std::uint32_t(value))) {}
    constexpr inline operator std::uint32_t() const noexcept { return std::uint32_t(i); }
    constexpr inline TzFlag(long value) noexcept : i(std::int32_t(value)) {}
    constexpr inline TzFlag(unsigned long value) noexcept : i(std::int32_t(long(value))) {}
};
...
constexpr inline QIncompatibleTzFlag::QIncompatibleTzFlag(std::int32_t value) noexcept : i(value) {}

namespace TzPrivate {

template <typename T> struct IsTzFlags : std::false_type {};
template <typename E> struct IsTzFlags<TzFlags<E>> : std::true_type {};

template <std::int32_t> struct QIntegerForSize;
template <>    struct QIntegerForSize<1> { typedef std::uint8_t  Unsigned; typedef std::int8_t  Signed; };
template <>    struct QIntegerForSize<2> { typedef std::uint16_t Unsigned; typedef std::int16_t Signed; };
template <>    struct QIntegerForSize<4> { typedef std::uint32_t Unsigned; typedef std::int32_t Signed; };
template <>    struct QIntegerForSize<8> { typedef std::uint64_t Unsigned; typedef std::int64_t Signed; };
...
public:
    ...
    constexpr inline explicit TzFlagsStorage(std::in_place_t, Int v) : i(v) {}
};
...
template <typename Enum> struct TzFlagsStorageHelper<Enum, sizeof(std::int32_t)> : TzFlagsStorage<Enum>
{
    using TzFlagsStorage<Enum>::TzFlagsStorage;
...
public:
    ...
    constexpr inline TzFlags(Enum flags) noexcept : Base(std::in_place, Int(flags)) {}
    ...
    constexpr inline TzFlags &operator&=(TzFlags mask) noexcept { i &= mask.i; return *this; }
    constexpr inline TzFlags &operator&=(Enum mask) noexcept { i &= Int(mask); return *this; }
    constexpr inline TzFlags &operator|=(TzFlags other) noexcept { i |= other.i; return *this; }
    constexpr inline TzFlags &operator|=(Enum other) noexcept { i |= Int(other); return *this; }
    constexpr inline TzFlags &operator^=(TzFlags other) noexcept { i ^= other.i; return *this; }
    constexpr inline TzFlags &operator^=(Enum other) noexcept { i ^= Int(other); return *this; }
    ...
    constexpr inline TzFlags operator|(TzFlags other) const noexcept { return TzFlags(std::in_place, i | other.i); }
    constexpr inline TzFlags operator|(Enum other) const noexcept { return TzFlags(std::in_place, i | Int(other)); }
    constexpr inline TzFlags operator^(TzFlags other) const noexcept { return TzFlags(std::in_place, i ^ other.i); }
    constexpr inline TzFlags operator^(Enum other) const noexcept { return TzFlags(std::in_place, i ^ Int(other)); }
    ...
    constexpr inline bool testFlags(TzFlags flags) const noexcept { return flags.i ? ((i & flags.i) == flags.i) : i == Int(0); }
    constexpr inline bool testAnyFlag(Enum flag) const noexcept { return testAnyFlags(flag); }
    constexpr inline bool testAnyFlags(TzFlags flags) const noexcept { return (i & flags.i) != Int(0); }
...
#define TZ_DECLARE_FLAGS(Flags, Enum) \
typedef TzFlags<Enum> Flags;
...
[[maybe_unused]] \
constexpr inline TzFlags<Flags::enum_type> operator|(Flags::enum_type f1, Flags::enum_type f2) noexcept \
{ return TzFlags<Flags::enum_type>(f1) | f2; } \
[[maybe_unused]] \
constexpr inline TzFlags<Flags::enum_type> operator|(Flags::enum_type f1, TzFlags<Flags::enum_type> f2) noexcept \
{ return f2 | f1; } \
[[maybe_unused]] \
constexpr inline TzFlags<Flags::enum_type> operator&(Flags::enum_type f1, Flags::enum_type f2) noexcept \
{ return TzFlags<Flags::enum_type>(f1) & f2; } \
...
constexpr inline void operator+(Flags::enum_type f1, TzFlags<Flags::enum_type> f2) noexcept = delete; \
constexpr inline void operator+(std::int32_t f1, TzFlags<Flags::enum_type> f2) noexcept = delete; \
constexpr inline void operator-(Flags::enum_type f1, Flags::enum_type f2) noexcept = delete; \
constexpr inline void operator-(Flags::enum_type f1, TzFlags<Flags::enum_type> f2) noexcept = delete; \
constexpr inline void operator-(std::int32_t f1, TzFlags<Flags::enum_type> f2) noexcept = delete; \
